...
import re
#The significance of "import *" represents all the functions and built-in modules in the tkinter library
# "*" imports everything from tkinter
from tkinter import *
#Tkinter provides the ttk package that is used to style the widget's property and its look and feel
